...
// const input = require('../../assets/cities.json');
...
export class WeatherDetailsComponent implements OnInit {
   ...
   * @param wd - weather service instace
   */
  constructor(private wd: WeatherDetailsService) {
  }

  /**
   * This method is used to call a method which collects weather data with
   * default city Pune
   */
  ngOnInit() {
    this.allCities = [
  ...
  /**
   * This method is used to get the weather data o city Pune
   * @param selectedCity - selected city
   */
  public getWeatherData(selectedCity) {
    this.loader = true;
    this.wd.getWeatherData(selectedCity).subscribe(res => {
